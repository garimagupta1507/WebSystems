...
export declare const crudGetManyReference: (reference: string, target: string, id: import("react").ReactText, relatedTo: string, pagination: Pagination, sort: Sort, filter: object, source: string) => CrudGetManyReferenceAction;

...
var UnconnectedReferenceInputController = /** @class */ (function (_super) {
    ...
    UnconnectedReferenceInputController.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        else if (!isEqual_1.default(nextProps.filter, this.props.filter) ||
...
exports.UnconnectedReferenceInputController = UnconnectedReferenceInputController;
var makeMapStateToProps = function () {
    return reselect_1.createSelector([
        ...
        matchingReferences: reducer_1.getPossibleReferences(referenceState, possibleValues, [inputId]),
        referenceRecord: referenceState && referenceState.data[inputId],
    }); });
};
var ReferenceInputController = compose_1.default(translate_1.default, react_redux_1.connect(makeMapStateToProps(), {
    crudGetManyAccumulate: accumulateActions_1.crudGetManyAccumulate,
    crudGetMatchingAccumulate: accumulateActions_1.crudGetMatchingAccumulate,
}))(UnconnectedReferenceInputController);
ReferenceInputController.defaultProps = {
    referenceSource: defaultReferenceSource,
};
exports.default = ReferenceInputController;

    ...
    function Query() {
        ...
        _this.componentDidUpdate = function (prevProps) {
            if (prevProps.type !== _this.props.type ||
                ...
                !isEqual_1.default(prevProps.payload, _this.props.payload) ||
                !isEqual_1.default(prevProps.options, _this.props.options)) {
                _this.callDataProvider();
            }
        };
        return _this;
...
exports.default = withDataProvider_1.default(Query);

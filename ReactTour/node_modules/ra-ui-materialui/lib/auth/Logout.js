...
var Logout = function (_a) {
    ...
    return (react_1.default.createElement(MenuItem_1.default, __assign({ className: classnames_1.default('logout', classes.menuItem, className), onClick: userLogout }, rest),
...
var enhance = compose_1.default(ra_core_1.withTranslate, react_redux_1.connect(undefined, mapDispatchToProps), styles_1.withStyles(styles));
var EnhancedLogout = enhance(Logout);
EnhancedLogout.propTypes = {
    className: prop_types_1.default.string,
    redirectTo: prop_types_1.default.string,
};
exports.default = EnhancedLogout;

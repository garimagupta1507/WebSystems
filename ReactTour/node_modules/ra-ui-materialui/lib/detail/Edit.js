...
exports.EditView = styles_1.withStyles(exports.styles)(function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: classnames_1.default('edit-page', classes.root, className) }, sanitizeRestProps(rest)),
        ...
        react_1.default.createElement(Card_1.default, { className: classes.card },
            actions && (react_1.default.createElement(CardContentInner_1.default, null, react_1.cloneElement(actions, __assign({ basePath: basePath, data: record, hasShow: hasShow,
                hasList: hasList,
 ...
 *     export default App;
 */
var Edit = function (props) { return (react_1.default.createElement(ra_core_1.EditController, __assign({}, props), function (controllerProps) { return react_1.default.createElement(exports.EditView, __assign({}, props, controllerProps)); })); };
Edit.propTypes = {
    actions: prop_types_1.default.element,
    aside: prop_types_1.default.node,

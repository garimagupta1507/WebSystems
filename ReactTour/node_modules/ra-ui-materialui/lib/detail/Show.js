...
exports.ShowView = styles_1.withStyles(exports.styles)(function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({ className: classnames_1.default('show-page', classes.root, className) }, sanitizeRestProps(rest)),
        ...
        react_1.default.createElement(Card_1.default, { className: classes.card },
            actions && (react_1.default.createElement(CardContentInner_1.default, null, react_1.cloneElement(actions, __assign({ basePath: basePath, data: record, hasList: hasList,
                hasEdit: hasEdit,
 ...
 *     export default App;
 */
var Show = function (props) { return (react_1.default.createElement(ra_core_1.ShowController, __assign({}, props), function (controllerProps) { return react_1.default.createElement(exports.ShowView, __assign({}, props, controllerProps)); })); };
Show.propTypes = {
    actions: prop_types_1.default.element,
    aside: prop_types_1.default.node,
    children: prop_types_1.default.element,

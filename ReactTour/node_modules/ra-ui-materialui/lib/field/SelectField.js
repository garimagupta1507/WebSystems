...
exports.SelectField = function (_a) {
    ...
    var choiceName = react_1.default.isValidElement(optionText) // eslint-disable-line no-nested-ternary
        ...
        : typeof optionText === 'function'
            ? optionText(choice)
            : choice[optionText];
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body1", className: className }, sanitizeRestProps_1.default(rest)), translateChoice
...
var enhance = compose_1.default(pure_1.default, ra_core_1.withTranslate);
var EnhancedSelectField = enhance(exports.SelectField);
EnhancedSelectField.defaultProps = {
    addLabel: true,
};
EnhancedSelectField.propTypes = __assign({}, Typography_1.default.propTypes, types_1.fieldPropTypes, { choices: prop_types_1.default.arrayOf(prop_types_1.default.object).isRequired, optionText: prop_types_1.default.oneOfType([

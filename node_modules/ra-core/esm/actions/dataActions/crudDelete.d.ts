...
export declare const crudDelete: (resource: string, id: import("react").ReactText, previousData: Record, basePath: string, redirectTo?: RedirectionSideEffect, refresh?: boolean) => CrudDeleteAction;

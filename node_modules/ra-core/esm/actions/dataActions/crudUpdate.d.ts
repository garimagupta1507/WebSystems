...
export declare const crudUpdate: (resource: string, id: import("react").ReactText, data: any, previousData: any, basePath: string, redirectTo?: RedirectionSideEffect, refresh?: boolean) => CrudUpdateAction;

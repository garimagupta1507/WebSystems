...
var possibleValuesreducer = function (previousState, action) {
    ...
    switch (action.type) {
        case CRUD_GET_MATCHING_SUCCESS:
            return __assign({}, previousState, (_a = {}, _a[action.meta.relatedTo] = action.payload.data.map(function (record) { return record.id; }), _a));
        case CRUD_GET_MATCHING_FAILURE:
            return __assign({}, previousState, (_b = {}, _b[action.meta.relatedTo] = { error: action.error }, _b));
        default:

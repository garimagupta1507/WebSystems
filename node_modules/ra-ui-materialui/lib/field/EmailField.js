...
var EmailField = function (_a) {
    ...
    return (react_1.default.createElement("a", __assign({ className: className, href: "mailto:" + get_1.default(record, source), onClick: stopPropagation }, sanitizeRestProps_1.default(rest)), get_1.default(record, source)));
};

...
exports.NumberField = function (_a) {
    ...
    if (!hasNumberFormat) {
        return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body1", className: className }, sanitizeRestProps_1.default(rest)), value));
    }
    return (react_1.default.createElement(Typography_1.default, __assign({ component: "span", variant: "body1", className: className }, sanitizeRestProps_1.default(rest)), value.toLocaleString(locales, options)));
};
...
EnhancedNumberField.propTypes = __assign({}, Typography_1.default.propTypes, types_1.fieldPropTypes, { locales: prop_types_1.default.oneOfType([
